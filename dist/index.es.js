...
const _sfc_main = defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const onAudioEnded = () => {
      ...
      audioProgress.value.style.width = `${audioProgressWrap.value.offsetWidth + 1}px`;
      clearTimer();
      emit("ended");
    };
    const onAudioPause = () => {
...
const _hoisted_9 = { class: "audio__player-time audio__player-time3333333333333333333333333 111111111111111111" };
...
var AudioPlayer = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-370a6415"]]);
